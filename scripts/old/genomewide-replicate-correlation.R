...
dev.off()
png(filename = paste0(bam.names[1],"vs",bam.names[2],"-correlation.png"),width = 480, height = 480)
plot(df.filt[,1],df.filt[,2], col=rgb(0,100,0,50,maxColorValue=255), 
         pch=16, log="xy", main="correlation-plot" , xlab = bam.names[1], ylab= bam.names[2],
          xaxt ='n',yaxt = 'n')
dev.off()
png(filename = paste0(bam.names[1],"vs",bam.names[3],"-correlation.png"),width = 480, height = 480)
plot(df.filt[,1],df.filt[,3], col=rgb(0,100,0,50,maxColorValue=255), 
     pch=16, log="xy", main="correlation-plot" , xlab = bam.names[1], ylab= bam.names[3],
     xaxt ='n',yaxt = 'n')
dev.off()
png(filename = paste0(bam.names[2],"vs",bam.names[3],"-correlation.png"),width = 480, height = 480)
plot(df.filt[,2],df.filt[,3], col=rgb(0,100,0,50,maxColorValue=255), 
