---
title: "chip differential narrow h3k4me3"
...
```{r}
df = df[,grepl("H3K4me3",colnames(df)),]
...
totalwindows_new = create_grangesnew_frombed3(data.frame(totalwindows)[as.logical(rowSums(df) >100),])
nrow(df_new)
