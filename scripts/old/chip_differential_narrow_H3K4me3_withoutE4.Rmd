---
title: "chip differential broad H3K36me3 without E4"
...
```{r}
path="count-tables/"
df = read.table(paste0(path,"merged_narrow_H3K4me3_counts.tsv"),sep="\t",header=T,row.names = 1)
#head(df[,1:3])
...
bedfile="count-tables/H3K4me3_merged_narrow.bed"
...
# 2Norm_vs_8wkHyp
```{r}
outputname = "Comparison4.1_h3k4me3_8wkNorm_vs_8wkHyp_withoutE4"
